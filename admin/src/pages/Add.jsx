...
const Add = ({ token }) => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault();
        setLoading(true); // Request start hone par button disable ho jaye
        ...
        try {
            ...
            setLoading(false); // Response aane ke baad button enable ho jaye
        }
    };
    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <button 
                ...
                disabled={loading} // Jab tak request pending hai, button disable rahega
            >
                {loading ? "Adding..." : "ADD"}
            </button>
        </form>
